...
export default function About() {
    ...
    return (
        <div className="mt-5 p-4 max-w-screen-lg mx-auto">
            <div className="flex justify-center">
                   <NavBar />
            </div>
            <p className="text-[40px] text-white my-4 font-bold text-center">ABOUT US</p>
            <div className="mt-5 p-4 flex flex-col gap-10 md:flex-row md:items-center">
            ...
            <div>
                <p
                    className="text-center text-white font-semibold text-[20px]"
                > <span>&copy;</span>All rights reserved</p>
            </div>
        </div>
    );
}
